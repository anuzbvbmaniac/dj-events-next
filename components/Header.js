...
import { MenuIcon, XIcon, InboxIcon} from '@heroicons/react/outline';
                                                ...
                                                <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                                                    <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8 lg:grid-cols-2">
                                                        ...
                                                        >
                                                            ...
                                                            <div className="ml-4">
                                                                <p className="text-base font-medium text-gray-900">Ongoing</p>
                                                                <p className="mt-1 text-sm text-gray-500">List of all ongoing events</p>
                                                            </div>
                                                        </a>
                                                        <a
                                                            href={'/events'}
                                                        ...
                                                        >
                                                            ...
                                                            <div className="ml-4">
                                                                <p className="text-base font-medium text-gray-900">Upcoming</p>
                                                                <p className="mt-1 text-sm text-gray-500">List of all upcoming events</p>
                                                            </div>
                                                        </a>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="mt-6">
                                        <nav className="grid grid-cols-1 gap-7">
                                                ...
                                                >
                                                    ...
                                                    <div className="ml-4 text-base font-medium text-gray-900">Event 1</div>
                                                </a>
                                            <a
                                                href="/events"
                                                className="-m-3 p-3 flex items-center rounded-lg hover:bg-gray-50"
                                            >
                                                ...
                                                <div className="ml-4 text-base font-medium text-gray-900">Event 2</div>
                                            </a>
                                        </nav>
                                    </div>
                                </div>
